...
import WeekFourQuiz from '@/components/WeekFourQuiz'
import CompleteButton from '@/components/CompleteButton'
import UnlockedWeekGate from '@/components/UnlockedWeekGate'

export default function WeekFourQuizPage() {
  return (
          ...
          <div className="relative mx-auto max-w-5xl px-5 py-16">
            ...
            <div className="mt-10 max-w-3xl">
              ...
              <p className="mt-5 text-lg leading-8 text-white/70">
                Test your understanding of AI product thinking before building your mini product plan.
              </p>
            </div>
          </div>
        </section>
