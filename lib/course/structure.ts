...
export const COURSE_WEEKS: CourseWeek[] = [
  ...
  },
  {
    ...
    quizHref: '/course/week-4/quiz',
    projectHref: '/course/week-4/project',
    items: [
      {
        title: 'Finding a Problem Worth Solving',
        href: '/course/week-4/finding-a-problem-worth-solving',
      ...
      },
      {
        ...
        href: '/course/week-4/designing-an-ai-feature',
        slug: 'designing-an-ai-feature',
        kind: 'lesson',
        available: true,
      },
      {
        title: 'Planning a Simple AI Product',
        href: '/course/week-4/planning-a-simple-ai-product',
        slug: 'planning-a-simple-ai-product',
        kind: 'lesson',
        available: true,
      },
      {
        title: 'Week 4 Self-Check',
        href: '/course/week-4/quiz',
        slug: 'self-check',
        kind: 'quiz',
        available: true,
      },
  ...
  },
  {
    ...
    quizHref: '/course/week-5/reflection',
    projectHref: '/course/week-5/project',
    items: [
      {
        title: 'Choosing Your Final Project',
        href: '/course/week-5/choosing-your-final-project',
        slug: 'choosing-your-final-project',
        kind: 'lesson',
        available: true,
      },
      {
        title: 'Building the Project Story',
        href: '/course/week-5/building-the-project-story',
        slug: 'building-the-project-story',
        kind: 'lesson',
        available: true,
      },
      {
        title: 'Presenting Your AI Work',
        href: '/course/week-5/presenting-your-ai-work',
        slug: 'presenting-your-ai-work',
        kind: 'lesson',
        available: true,
      },
      {
        title: 'Final Reflection',
        href: '/course/week-5/reflection',
